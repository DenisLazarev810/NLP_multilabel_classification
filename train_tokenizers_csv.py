...
trainer = WordPieceTrainer(special_tokens=["[BOS]", "[EOS]", "[UNK]", "[CLS]", "[SEP]", "[PAD]", "[MASK]"],
                           vocab_size=24000)
...
trainer = BpeTrainer(special_tokens=["[BOS]", "[EOS]", "[UNK]", "[CLS]", "[SEP]", "[PAD]", "[MASK]"],
                     vocab_size=20000)
tokenizer.train_from_iterator(item_names, trainer)
...
trainer = UnigramTrainer(special_tokens=["[BOS]", "[EOS]", "[UNK]", "[CLS]", "[SEP]", "[PAD]", "[MASK]"],
                         vocab_size=16000)
tokenizer.train_from_iterator(item_names, trainer)
